...
describe('Booking API Test', () => {
  ...
  describe('Peak Season Holiday Booking', () => {
    const testCases = [
      {
        description: 'One-day holiday booking is made using available nights',
        payload: {
          user: { id: 2 },
          property: { id: 1 },
          createdBy: { id: 1 },
      ...
      {
        description:
          'Multiple day holiday booking is made using available nights',
        payload: {
          user: { id: 2 },
          property: { id: 1 },
          createdBy: { id: 1 },
      ...
      {
        description: 'Booking is made consecutively for 14 nights',
        payload: {
          user: { id: 2 },
          property: { id: 2 },
          createdBy: { id: 1 },
