...
describe('Booking API Test', () => {
  ...
  describe('Peak Season Booking with Last Minute', () => {
    const testCases = [
      {
        description:
      ...
      },
      {
        ...
        payload: {
          ...
          checkoutDate: '2025-04-02T11:51:55.260Z',
          noOfGuests: 10,
          noOfPets: 2,
          isLastMinuteBooking: true,
          noOfAdults: 6,
      ...
      },
      {
        ...
        payload: {
          ...
          checkoutDate: '2025-05-04T11:51:55.260Z',
          noOfGuests: 10,
          noOfPets: 2,
          isLastMinuteBooking: true,
          noOfAdults: 5,
      ...
      },
      {
        ...
        payload: {
          ...
          checkoutDate: '2026-05-04T11:51:55.260Z',
          noOfGuests: 10,
          noOfPets: 2,
          isLastMinuteBooking: true,
          noOfAdults: 5,
